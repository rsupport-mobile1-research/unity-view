...
-(void)sendFrameToMyRender:(RTCVideoFrame *)frame{
    ...
    [userInfo setObject:[NSString stringWithFormat:@" %lld",self.textureId] forKey:@"texture"];
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"PhatKTrender" object:imageData userInfo:userInfo];

//    [[NSNotificationCenter defaultCenter] postNotificationName:@"PhatKTrender2" object:imageData userInfo:nil];
    NSLog(@"gui thong tin ne");
